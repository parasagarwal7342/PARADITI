# P Λ R Λ D I T I - Official Hackathon Submission Narrative

This document contains the narrative components required for the **Hack2Skill** project submission.
...
🚀 **Announcing P Λ R Λ D I T I: The AI-Native Social Operating System for 800M Citizens!**

Discovery ❌ Mobility ✅

For years, we've built "listing portals" for government welfare. Today, I’m thrilled to unveil **P Λ R Λ D I T I**—Bharat's first AI-Powered gateway that doesn't just tell you what schemes exist, but **guarantees** you get them.

**Why Paraditi matters:**
1. 🤖 **Aditi AI**: A voice-first AI that understands Bhojpuri, Maithili, and Hindi better than any LLM (Claim I).
2. 🛡️ **Zero Downtime**: Our "Fallback Mesh" (Claim A) ensures welfare discovery even when government APIs are unstable.
3. 📉 **Credit for the Unbanked**: We turn your welfare history into a **UBS Score**, unlocking micro-credit without collaterals.
...
## Part C: Live Preview Instructions (For Judges)

1.  Visit the **Live Cloud Run URL**.
2.  Use the **Aditi AI Orb interface** to discover schemes using natural language.
3.  Navigate to the **Social Credit Dashboard** to see how UBS logic converts history into credit.
4.  Test the **One-Click Filing** flow for "PMAY Urban" or "MUDRA Loan".
